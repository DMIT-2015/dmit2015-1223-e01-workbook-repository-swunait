...
public class AutomaticTimersBean {        // Also known as Calendar-Based Timers
        ...
        public void dmit2015SectionOA01ClassNotifiation(Timer timer) {
         ...
         @Schedule(second = "0", minute ="16", hour = "20", dayOfWeek = "Mon,Wed,Fri", month = "May-Aug", year = "2023", info ="DMIT2015-OE01 Meeting", persistent = false)
        public void dmit2015SectionOE01ClassNotifiation(Timer timer) {
                //sendEmail(timer);
                 _logger.info("Hey you have a class meeting today.");
        }
