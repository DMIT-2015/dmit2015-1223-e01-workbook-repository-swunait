...
public interface TodoItemMultiUserMpRestClient {
    ...
    @POST
    Response create(TodoItemMultiUser newTodoItem, @HeaderParam("Authorization") String bearerAuth);
    ...
    @PUT
    @Path("/{id}")
    TodoItemMultiUser update(@PathParam("id") Long id, TodoItemMultiUser updatedTodoItem, @HeaderParam("Authorization") String bearerAuth);
